...
calculation = "" #if you are doing by downside method no need of this

#def Button_press(num):
 #   global equation_text
  #  equation_text = equation_text + str(num)
   # equation.label.set(equation_text)
...
btn_open = tk.Button(root, text="(", command=lambda: add_to_calculation(open), width=5, font=("Arial", 14))
btn_open.grid(row=5, column=1)
btn_close = tk.Button(root, text=")", command=lambda: add_to_calculation(close), width=5, font=("Arial", 14))
